...
* The original package name 'EmployeeDetails-Service.EmployeeDetails-Service' is invalid and this project uses 'EmployeeDetails_Service.EmployeeDetails_Service' instead.
